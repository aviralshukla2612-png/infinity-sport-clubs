...
import ground1Img from '../assets/images/pickel1.jpg';
import ground2Img from '../assets/images/pickel2.jpg';
import ground3Img from '../assets/images/pickel3.jpg';
import './PickleballBooking.css';

const grounds = [
  { id: 1, name: 'Ground 1', isPremium: true, type: 'Outdoor Court', format: 'Doubles', price: 1999, image: ground1Img },
  { id: 2, name: 'Ground 2', isPremium: false, type: 'Outdoor Court', format: 'Doubles', price: 1799, image: ground2Img },
  { id: 3, name: 'Ground 3', isPremium: false, type: 'Outdoor Court', format: 'Doubles', price: 1799, image: ground3Img },
  { id: 4, name: 'Ground 4', isPremium: false, type: 'Outdoor Court', format: 'Doubles', price: 1599, image: ground1Img },
  { id: 5, name: 'Ground 5', isPremium: false, type: 'Outdoor Court', format: 'Doubles', price: 1999, image: ground2Img }
];
    ...
    <div className="pickleball-booking-container animate-fade-in">
      ...
      <div className="parallax-hero">
        ...
        <div className="hero-content">
          <div className="breadcrumbs">
            <span>Home</span> &gt; <span>Sports</span> &gt; <span>Pickleball</span> &gt; <span className="active">Book Ground</span>
          </div>
          ...
          <div className="hero-title-section">
            ...
            <h1 className="hero-title">Book <span>Pickleball Court</span></h1>
          </div>
          <p className="hero-subtitle">
            {step === 5 
              ? 'Review your booking details before confirming.'
              : 'Select your preferred court, date and time to book your pickleball court.'}
          </p>
        </div>
      </div>
      ...
      <div className="booking-main-content">
          ...
          <div className="booking-grid">
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                        {[...Array(playerCount === '10+' ? 9 : playerCount - 1)].map((_, i) => (
                          <div key={i} style={{ background: '#111', padding: '1rem', borderRadius: '8px', border: '1px solid #222' }}>
                            <div style={{ fontSize: '0.85rem', color: '#10B981', marginBottom: '0.5rem', fontWeight: 600 }}>Player {i + 2}</div>
            ...
            <div className="right-panel">
              ...
              <div className="summary-row">
                ...
                <span className="value highlight">Pickleball</span>
              </div>
        ...
        <div className="facilities-bar">
          <div className="facility-item"><Map size={18} /><span>7+ Pickleball Courts</span></div>
             ...
             <div style={{display: 'flex', gap: '1rem', marginTop: '2rem'}}>
              ...
              <button className="next-btn" style={{flex: 2}} onClick={() => {
                ...
                const bookingRecord = {
                  ...
                  ground: `Indoor Court · ${selectedGround.name}`,
          ...
          <div className="payment-modal animate-fade-in" style={{ maxWidth: '500px', width: '90%', maxHeight: '80vh', overflowY: 'auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ background: '#111', padding: '1rem', borderRadius: '8px', border: '1px solid #222' }}>
                <div style={{ fontSize: '0.85rem', color: '#10B981', marginBottom: '0.5rem', fontWeight: 600 }}>Player 1 (Main)</div>
