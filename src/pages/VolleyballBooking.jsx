...
import ground1Img from '../assets/images/ball1.jpg';
import ground2Img from '../assets/images/ball2.jpg';
import ground3Img from '../assets/images/ball3.jpg';
import './VolleyballBooking.css';

const grounds = [
  { id: 1, name: 'Ground 1', isPremium: true, type: 'Indoor Court', format: '6 v 6', price: 1999, image: ground1Img },
  { id: 2, name: 'Ground 2', isPremium: false, type: 'Indoor Court', format: '6 v 6', price: 1799, image: ground2Img },
  { id: 3, name: 'Ground 3', isPremium: false, type: 'Indoor Court', format: '6 v 6', price: 1799, image: ground3Img },
  { id: 4, name: 'Ground 4', isPremium: false, type: 'Indoor Court', format: '6 v 6', price: 1599, image: ground1Img },
  { id: 5, name: 'Ground 5', isPremium: false, type: 'Indoor Court', format: '6 v 6', price: 1999, image: ground2Img }
];
    ...
    <div className="volleyball-booking-container animate-fade-in">
      ...
      <div className="parallax-hero">
        ...
        <div className="hero-content">
          <div className="breadcrumbs">
            <span>Home</span> &gt; <span>Sports</span> &gt; <span>Volleyball</span> &gt; <span className="active">Book Ground</span>
          </div>
          ...
          <div className="hero-title-section">
            ...
            <h1 className="hero-title">Book <span>Volleyball Court</span></h1>
          </div>
          <p className="hero-subtitle">
            {step === 5 
              ? 'Review your booking details before confirming.'
              : 'Select your preferred court, date and time to book your volleyball court.'}
          </p>
        </div>
      </div>
      ...
      <div className="booking-main-content">
          ...
          <div className="booking-grid">
            ...
            <div className="right-panel">
              ...
              <div className="summary-row">
                ...
                <span className="value highlight">Volleyball</span>
              </div>
        ...
        <div className="facilities-bar">
          <div className="facility-item"><Map size={18} /><span>7+ Volleyball Courts</span></div>
